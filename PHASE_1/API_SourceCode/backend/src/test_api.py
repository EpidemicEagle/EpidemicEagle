...
def test_search():
    ...
    response = client.get("/api/v1/search", params={"start_date":"2018-xx-xx xx:xx:xx", "end_date":"2018-xx-xx xx:xx:xx", "key_terms":"wow,no", 'location':'sydney'})
    assert response.status_code == 200
